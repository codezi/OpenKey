...
+(void)checkNewVersion:(NSWindow*)parent callbackFunc:(CheckNewVersionCallback) callback {
    ...
    [[aSession dataTaskWithURL:[NSURL URLWithString:@"https://raw.githubusercontent.com/codezi/OpenKey/master/version.json"] completionHandler:^(NSData *data, NSURLResponse *response, NSError *error) {
